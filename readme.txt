=== Check-Mail-SMTP ===
Contributors: Jploft
Donate link: http://jploft.com
Tags: check,smtp, mail, mailer, phpmailer, wp_mail, email
...
[Check-Mail-SMTP](https://#) plugin allows you to configure a mail server which handles all outgoing email from your website. It takes control of the wp_mail function and use SMTP instead.You can 
take record also.
...
1. Browse for the plugin file (Check-Mail-SMTP) on your computer
